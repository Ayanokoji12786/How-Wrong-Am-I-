...
export const resolveRemotePrediction = (id: string, actualOutcome: boolean, source: string) => request<{ ok: true }>(`/api/predictions/${id}/resolve`, { method: 'POST', body: JSON.stringify({ actualOutcome, source }) })
